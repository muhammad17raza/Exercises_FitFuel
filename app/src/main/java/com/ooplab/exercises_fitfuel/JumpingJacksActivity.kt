...
// Check if all necessary landmarks are detected
                        if (leftHip != null && rightHip != null &&
                            ...
                            runOnUiThread {
                                ...
                                val armsUpCondition = (angleLeftShoulder >= 160 && angleLeftShoulder <= 180) &&
                                        (angleRightShoulder >= 160 && angleRightShoulder <= 180)
                                val legsOutCondition = (angleLeftLeg >= 160 && angleLeftLeg <= 180) &&
                                        (angleRightLeg >= 160 && angleRightLeg <= 180)

                                val armsDownCondition = (angleLeftShoulder >= 20 && angleLeftShoulder <= 40) &&
                                        (angleRightShoulder >= 20 && angleRightShoulder <= 40)
                                val legsInCondition = (angleLeftLeg >= 20 && angleLeftLeg <= 40) &&
                                        (angleRightLeg >= 20 && angleRightLeg <= 40)


                                // Check the stage and conditions for rep counting
                                if (armsUpCondition || legsOutCondition && stage == "Down") {
                                    // When both arms and legs reach the "Up" position, set stage to "Up"
                                    stage = "Up"
                                    isAtUpPosition = true
                                } else if (isAtUpPosition && armsDownCondition || legsInCondition) {
                                    ...
                                    isAtUpPosition = false // Reset the "Up" position tracker
                                }
